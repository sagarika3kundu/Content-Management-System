...
<body data-spy="scroll" data-target="#navigation_bar">
    ...
    <div class="banner_inner">
    	<img src="images/company_profile_banner.jpg" alt="...">
    </div>
       ...
       <section class="welcome">
         <div class="container">
          	<div class="row">
            	<div class="col-sm-12">
                	<div class="mission company_profile clearfix">
                    	<h4 class="heading"><span>company &nbsp;</span>profile</h4>
                      <?php
      $cms=mysql_fetch_array(mysql_query("select * from `cms` where page_id = '5'"));
      ?>
                    <img src="<?php echo "admin/".$cms['page_image_thumb2']; ?>" class="pull-left"/>
                        <?php echo $cms['page_desc']; ?>
                    </div>
                </div>
            </div>          
		 </div>   
